  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:description" content="Hansen-MacDonald Professor of Neurological Surgery and Director of Neurosurgery Spine at Weill Cornell Medicine." />
      ...
      <section className={styles.bioSection}>
        <div className={styles.headerSection}>
          ...
          <div>
            ...
            <Link href="/Contact"><b>here.</b></Link>
          </div>
        </div>
        ...
        <div className={styles.content}>
          <div id="personal-statement" className={styles.section}>
            ...
            <div className={styles.textSection}>
              <h2>Mission</h2>
              <p>
                My mission is to bring together leading experts and streamlined services to deliver complete care for back and neck problems—all in one convenient location. Surgery is one of many tools we offer. When it&apos;s needed, I focus on the least invasive, most effective option to help patients return to the life and activities they love.
              </p>

              <h2>Pledge to My Patients</h2>
              <ol className={styles.pledgeList}>
                <li>Interdisciplinary evaluation to identify the source of your pain and related symptoms.</li>
                <li>Treatment begins with the least invasive option appropriate for your condition.</li>
                <li>If surgery is recommended, I offer the least invasive approach that is safe, effective, and durable.</li>
          ...
          <div id="biography" className={styles.section}>
            <div className={styles.textSection}>
              ...
              <ul className={styles.biographyList}>
                ...
                <li>Founder and Co-Director of the Center for Comprehensive Spine Care at NewYork-Presbyterian/Weill Cornell Medicine</li>
                <li>Neurosurgeon for the New York Giants Football Team</li>
                <li>Pioneer in minimally invasive spinal surgery and computer-assisted spinal navigation</li>
                <li>Expert in biological approaches for disc repair and regeneration</li>
                <li>Patients travel globally, including physicians, surgeons, and other spine experts</li>
                <li>Recognized by New York Super Doctors, America&apos;s Top Surgeons, America&apos;s Best Doctors, and <em>New York</em> magazine&apos;s Best Doctors</li>
                <li>Authored 300+ peer-reviewed articles and three books on minimally invasive spine surgery and disc repair</li>
              </ul>
            </div>
          </div>
          ...
          <div id="training" className={styles.section}>
            <div className={styles.textSection}>
              ...
              <ul className={styles.List}>
                ...
                <li>Fellowship in complex spine surgery at Barrow Neurological Institute under Dr. Volker Sonntag</li>
              </ul>
            </div>
          </div>
          ...
          <div className={styles.section} aria-label="Helpful links">
            <div className={styles.textSection}>
              ...
              <p>
                Learn about{' '}
                <Link href="/treatments/minimally-invasive-spine-surgery">minimally invasive spine surgery</Link>,
                explore our{' '}
