    ...
    <section className={styles.researchSection}>
      ...
      <div className={styles.contentSection}>
        ...
        <div className={styles.textContainer}>
          ...
          <p>Biology research is advancing lasting solutions for degenerative disc disease through regeneration, repair, and replacement.</p>
          <Link href="https://drive.google.com/file/d/1wBzGVvVQgyW24eFPGPJmLp_4Gyigmpvb/preview" target="_blank">Watch Lecture</Link>
        </div>
      </div>

      <div className={styles.contentSection}>
        <div className={styles.imageContainer2}>
          <img src="/img/stemcells.png" alt="Research images" />
        </div>
        <div className={styles.textContainer}>
